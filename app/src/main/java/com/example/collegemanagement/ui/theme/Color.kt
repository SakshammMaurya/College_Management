package com.example.collegemanagement.ui.theme
...
val LightYellow = Color(0xFFFFEDB9)
val BrightYellow = Color(0xFFFFD34F)
val LightGreen = Color(0xFFBBF3E2)
val LightOrange = Color(0xFFFEE5D9)